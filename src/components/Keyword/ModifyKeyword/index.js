        ...
        <>
            ...
            <S.SettingContainer>
                <S.ModeContainer>
                    ...
                    <S.VibrationCheckBox onClick={onClickVibrationAlarm} isVibrationAlarm={isVibrationAlarm}></S.VibrationCheckBox>
                ...
                <S.AlarmContainer>
                    ...
                    <S.AlarmType>
                        {ALARM_TERM.map((item)=>{
                            return(
                                <S.Type onClick={()=>onClickAlarmTerm(item.id)} alarmTerm={alarmTerm} checkId={item.id} key={item.id}>{item.time}</S.Type>
                            )
                        })}
                    </S.AlarmType>
                </S.AlarmContainer>
