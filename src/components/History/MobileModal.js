...
const NotReadMail = () => {
  return(
    ...
    <path d="M2 5.333 7.26 8.84a1.333 1.333 0 0 0 1.48 0L14 5.333M3.333 12.666h9.334A1.333 1.333 0 0 0 14 11.333V4.666a1.334 1.334 0 0 0-1.333-1.333H3.333A1.333 1.333 0 0 0 2 4.666v6.667a1.333 1.333 0 0 0 1.333 1.333z" stroke="#999" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  )
}
const ReadMail = () => {
